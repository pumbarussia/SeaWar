...
function loadDiv(){
    jQuery('body').append('<div id	="main"></div>');
        ...
        jQuery('#main').append('<div id =   "rightPanel"></div>');
            jQuery('#rightPanel').append('<input type="radio" name="killShip" value="0" />Вставка<br    />');
            jQuery('#rightPanel').append('<input type="radio" name="killShip" value="1" />Удаление<br    />');
    ...
    jQuery('input[name=killShip][value=0]').attr('checked','checked');
